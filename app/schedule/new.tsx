...
import { scheduleAppointmentNotification } from '../../src/utils/notifications';
...
export default function NewScheduleScreen() {
  ...
  const [date, setDate] = useState<Date>((() => { const d = new Date(); d.setDate(d.getDate() + 1); d.setHours(12, 0, 0, 0); return d; })());
  ...
  const handleSave = async () => {
    ...
    try {
      const schedule = await useScheduleStore.getState().add({
  ...
  return (
    ...
    >
      <Stack.Screen options={{ title: '予定を追加', presentation: 'modal' }} />
      <ScrollView
        style={styles.flex}
      ...
      <View style={styles.footer}>
        ...
        >
          {isSubmitting ? (
            ...
            <Text style={styles.saveButtonText}>予定を追加</Text>
          )}
        </Pressable>
      </View>
    </KeyboardAvoidingView>
